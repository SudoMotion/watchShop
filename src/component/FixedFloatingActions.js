  ...
  return (
    <div className="fixed bottom-5 right-4 z-50 flex flex-col items-end gap-3 pb-[max(0.25rem,env(safe-area-inset-bottom))] sm:bottom-6 sm:right-5">
      ...
      <a
        ...
        className="flex h-8 w-8 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-2 ring-white/30 transition-transform hover:scale-105 hover:bg-[#20BD5A] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 sm:h-12 sm:w-12"
