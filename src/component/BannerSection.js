  ...
  return (
    <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-7 gap-5 mb-10 md:h-[400px] px-2'>
        <div className='col-span-1 md:col-span-4 rounded-md md:rounded-lg overflow-hidden'>
            <Link href={gifBannerLink} className='block h-full w-full select-none' onContextMenu={blockBannerContextMenu}>
              <video preload='true' autoPlay loop muted playsInline className='h-full w-full object-cover' onContextMenu={blockBannerContextMenu}>
        ...
        <div className='col-span-1 md:col-span-3 rounded-md md:rounded-lg overflow-hidden'>
            <Link href={stickyBannerLink} className='block h-full w-full select-none' onContextMenu={blockBannerContextMenu}>
              <Image
