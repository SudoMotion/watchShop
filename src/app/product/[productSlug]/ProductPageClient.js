  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 mt-6 sm:mt-8">
        ...
        <div className="z-30 flex flex-wrap items-center gap-2 sm:gap-4 md:gap-6 sticky top-[50px] bg-white shadow-md px-2 sm:px-3 overflow-x-auto scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <button
